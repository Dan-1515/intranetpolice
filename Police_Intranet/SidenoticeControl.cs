...
namespace Police_Intranet
{
    public partial class SideNoticeControl : UserControl
    {
        ...
        private readonly (string Text, string Message)[][] categoriesData = new (string, string)[][]
        {
            ...
            new (string, string)[] { ("이륙 공지", "/팩션공지 치즈 경찰청에서 안내 드립니다. 경찰청 헬기 이륙합니다."), ("항공 순찰", "/팩션공지 치즈 경찰청에서 안내 드립니다. 헬기 순찰을 위해 경찰청 헬기 이륙합니다."), ("면접&&시험", "/팩션공지 치즈 경찰청에서 안내 드립니다. 헬기 면접&시험 진행을 위해 경찰청 헬기 이륙합니다."), ("헬기 연습", "/팩션공지 치즈 경찰청에서 안내 드립니다. 경찰청 헬기 연습을 위해 이륙합니다.") },
            new (string, string)[] { ("206", "/팩션공지 치즈 경찰청에서 안내 드립니다. 현 시간부로 [ 206번지 ATM ]에 강도가 침입했습니다. 주위 한 블럭 이내로 접근시 공범으로 간주되어 사살 될 수 있습니다. 시민 여러분들의 협조를 부탁 드립니다."), ("584 ", "/팩션공지 치즈 경찰청에서 안내 드립니다. 현 시간부로 [ 584번지 ATM ]에 강도가 침입했습니다. 주위 한 블럭 이내로 접근시 공범으로 간주되어 사살 될 수 있습니다. 시민 여러분들의 협조를 부탁 드립니다."), ("814", "/팩션공지 치즈 경찰청에서 안내 드립니다. 현 시간부로 [ 814번지 ATM ]에 강도가 침입했습니다. 주위 한 블럭 이내로 접근시 공범으로 간주되어 사살 될 수 있습니다. 시민 여러분들의 협조를 부탁 드립니다."),},
            new (string, string)[] {
                ...
                ("803", "/팩션공지 치즈 경찰청에서 안내 드립니다. 현 시간부로 [ 803번지 편의점 ]에 강도가 침입했습니다. 주위 한 블럭 이내로 접근시 공범으로 간주되어 사살 될 수 있습니다. 시민 여러분들의 협조를 부탁 드립니다."),
                
            },
            new (string, string)[] { ("692", "/팩션공지 치즈 경찰청에서 안내 드립니다. 현 시간부로 [ 692번지 빈집 ]에 강도가 침입했습니다. 주위 한 블럭 이내로 접근시 공범으로 간주되어 사살 될 수 있습니다. 시민 여러분들의 협조를 부탁 드립니다.") },
            new (string, string)[] {
